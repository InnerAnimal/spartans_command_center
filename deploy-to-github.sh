...
# Meauxbility Deployment Script
# Deploys entire buildout to GitHub Pages
...
if [ ! -d ".git" ]; then
    ...
    git init
    git add .
    git commit -m "Initial Meauxbility deployment"
fi

# Set up GitHub Pages remote
...
git add dist/ -f
git commit -m "Deploy Meauxbility buildout - $(date)"
