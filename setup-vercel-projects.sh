...
################################################################################
# VERCEL MONOREPO SETUP - Interactive 3-Project Setup
################################################################################
...
╔═══════════════════════════════════════════════════════════════╗
║                                                               ║
║          VERCEL MONOREPO SETUP - 3 PROJECTS                   ║
║                                                               ║
╚═══════════════════════════════════════════════════════════════╝
EOF
echo -e "${NC}"
...
echo -e "${CYAN}This script will help you set up 3 Vercel projects:${NC}"
...
read -p "$(echo -e ${CYAN}Press Enter to link and deploy Meauxbility...${NC})"
...
vercel env add NODE_ENV production production <<< "production"
vercel env add PROJECT_NAME production production <<< "meauxbility"
...
read -p "$(echo -e ${CYAN}Press Enter to link and deploy Inner Animal...${NC})"
...
echo -e "${BLUE}Setting environment variables...${NC}"
vercel env add NODE_ENV production production <<< "production"
vercel env add PROJECT_NAME production production <<< "inneranimal"
...
read -p "$(echo -e ${CYAN}Press Enter to link and deploy iAutodidact...${NC})"
...
echo -e "${BLUE}Setting environment variables...${NC}"
vercel env add NODE_ENV production production <<< "production"
vercel env add PROJECT_NAME production production <<< "iautodidact"
